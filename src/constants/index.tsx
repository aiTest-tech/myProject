...
export const features = [
    ...
    },
    {
        ...
        text: "This initiative embodies the spirit of governance championed by Prime Minister Shri Narendra Modi, focusing on the welfare of the common man, the poor, and the underprivileged, and upholding the tradition of good governance",
        button: {
...
export const details = [
    ...
    {
        id: "1",
        icon: "/images/icons/governance.png",
        title: "Governance",
    },
    {
        id: "2",
...
export const faq = [
    ...
    {
        id: "1",
        question: "2.	Who launched the Chief Minister Fellowship Program?",
        answer:
            "The Program was Launched by Hon CM Shri Bhupendrabhai Patel on 31st Oct 2023",
    },
    {
        id: "2",
        question: "What is the duration of the Chief Minister Fellowship, 2024?",
        answer:
            "Fellows will be engaged for a fixed period of 1 year, which may be extended by 1 year at a time, However, their continuation in their respective positions beyond the first year would depend on a satisfactory Annual Performance Review based on clearly defined Key Performance Indicators",
    },
    {
        id: "3",
        question: "When can I apply for the Chief Minister Fellowship, 2023?",
        answer:
            "The application process for the Chief Minister Fellowship,starts on 2nd Dec 2023 Feb3. The last date for the submission of the application is 30th Dec, 2023",
    },
    {
        id: "4",
        question: "How much is the application fee for the Chief Minister Fellowship, 2023?",
        answer:
            "The application fee for the Chief Minister Fellowship, is Rs. 500.",
    },
    {
        id: "5",
        question: "What is the Educational Qualifications, Age and Experience required for Fellowship?",
        answer:
            "•	Standard 10th and 12th passed with minimum 60%" + "•	Bachelor’s Degree with minimum 60%" + "•	Importance will be given to the prime national institutes " + "•	Age shall not be more than 35 years on last date of application" + "•	Minimum 3 years of experience of relevant subject",
    },
    {
        id: "6",
    ...
    },
    {
        ...
        answer:
            "20 fellows will be appointed at the end of the selection process in the fellowship programme, however, the actual need will be determined over time.",
    },
    {
        id: "8",
    ...
    },
    {
        ...
        answer: "Fellows will work directly under the senior government officials, who will mentor the fellows. Fellows will interact frequently with these officials and update them on their assignments. Fellows will have to submit their monthly report to their mentors." + "Hon’ble Chief Minister will also review the assignments of the fellows as an when required."
    },
    // {
    //     id: "11",
    //     question: "What is the nature of work / assignments undertaken by fellows?",
    //     answer: "The task will revolve around specific topics, each accompanied by a predetermined problem statement to guide the assignment. The Topics are as follows-" + "•	Improvement in implementation of PM Poshan (MDM) and ICDS schemes" + "•	Developmental Areas/Block Programme: Reducing wasting/stunting in children" + "•	To improve enrolment of students in science and mathematics stream at secondary / higher secondary level." + " •	Improvement in total Students enrolment in secondary and higher secondary Schools" + " •	Revising the annual revenue share of government hospitals/facilities under PMJAY scheme" + " •	To develop a strategy for adoption of light house technology in Government for public programs" + "•	Recycling of Municipal Waste – Liquid and Solid Waste" + "•	Develop strategies to promote natural farming in the state" + "•	Achievement of complete irrigation capacity and optimal utilization of Narmada water resources" + "•	Tourism Promotion: Heritage, Wildlife, Beach, Conference, Sports, City, Border, Religious, Circuit etc" + "•	Pollution Control: Industrial and Urban: Problem Statement on the said subject" + "•	Policy Intelligence Unit Framework" + "•	To establish Training and Capacity building as a Good Governance practice." + "•	Recycling of Rural Waste – Liquid and Solid Waste" + "•	Technical and financial - work of DISCOMs" + "•	Viksit 2047 Gujarat Goal and working of various indices " + "•	Study of cultural relations between Gujarat and other states" + "•	MBKVY – Mukhyamantri Bhavishyalakshi Kaushalya Vikas Yojana" + "•	Scholarship Program for International Studies offered by the developing cast welfare Department (Videsh Abhyas Loan Yojana) • Financial Assistance Scheme to the Elderly and Handicapped" + "•	Sustainable livelihood for economic and social development in tribal area"
    // },
    // {
    //     id: "12",
